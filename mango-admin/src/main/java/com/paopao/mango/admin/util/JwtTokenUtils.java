package com.paopao.mango.admin.util;

import com.paopao.mango.admin.security.GrantedAuthorityImpl;
...
/**
 * JWT工具类
 * Create by paopao on 2019-11-17 20:27
 */
public class JwtTokenUtils implements Serializable {
    ...
    public static String getToken(HttpServletRequest request) {
        ...
        if (token == null) {
            ...
            token.substring(tokenHead.length());
        }
        if ("".equals(token)) {
            token = null;
        }
